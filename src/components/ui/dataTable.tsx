    ...
    <div className=" p-4 rounded-md shadow-lg border border-gray-200">
      <div className="flex items-center py-4 gap-2">
        ...
        <Input
          ...
          className="max-w-sm"
        />
        <Button variant="outline" className="bg-green-600 text-white" onClick={handleAdd}>Nuevo</Button>
      </div>
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-24 text-center">
                    <div className="flex flex-col items-center justify-center">
                        <img className="w-24 h-24" src="/images/search-empty.png" alt="No se encontraron resultados" />
